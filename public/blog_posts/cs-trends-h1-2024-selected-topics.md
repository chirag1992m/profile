...
I thought I'll be writing next article right after the [previous article](https://digital-madness.in/writing/cs-trends-h1-2024/) was published. Life keeps getting in between. Anyway, coming to the list of most common words extracted from arxiv articles as given in the banner image wordcloud and introduced in the [previous article](https://digital-madness.in/writing/cs-trends-h1-2024/) are given in the block below (You can expand the full list by clicking on `All Words` below):

<details>
<summary>All words</summary>

All words extracted via the [wordcloud](https://pypi.org/project/wordcloud/) python package since 2007:
...
We'll try go over each of them, ignoring all the irrelevant ones which are listed below, explaining them on a high-level. As [Albert Einstein](https://en.wikipedia.org/wiki/Albert_Einstein) said,
...
These are the ignored words as they are common or duplicated words and need not be explained in this blog:

...
export const dictionary: Record<string, DictionaryEntry> = {
    'transformer': {
        word: 'transformer',
        definition: 'A deep learning model architecture introduced in "Attention Is All You Need" (2017) that uses self-attention mechanisms to process sequential data.',
        pronunciation: '/trænsˈfɔːrmər/',
        etymology: 'From "transform" + "-er", referring to its ability to transform input sequences.',
        examples: [
    ...
    'AGI': {
        word: 'AGI',
        definition: 'Artificial General Intelligence - AI that can understand, learn, and apply knowledge across a wide range of tasks at a human level or beyond.',
    ...
    'Adsense': {
        word: 'Adsense',
        definition: 'Google\'s advertising platform that allows website owners to display targeted ads and earn revenue.',
    ...
    'slop': {
        word: 'slop',
        definition: 'In AI context, refers to low-quality, automated, or AI-generated content that lacks human oversight and quality.',
        pronunciation: '/slɒp/',
        examples: [
    ...
    'agentic': {
        word: 'agentic',
        definition: 'Relating to AI agents that can act autonomously and make decisions without human intervention.',
